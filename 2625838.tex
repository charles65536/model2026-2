...
%%%%%%%%%%% Begin Summary %%%%%%%%%%%
\thispagestyle{empty}
\input{chapters/0_summary_sheet.tex}
\clearpage
%%%%%%%%%%% End Summary %%%%%%%%%%%
...
\input{chapters/report_on_use_ai.tex}
\endgroup
\end{document}