...
we find that the final rankings of all four contestants drop significantly in the Tabel~\ref{}. This indicates a notable discrepancy in the tolerance for controversial 
...
%     \begin{tabular}{lcc}
%         \toprule
%         Contestant & Original Ranking & Re-ranked Position \\
%         \midrule
%         Jerry Rice & 2nd & 7th \\
%         Billy Ray Cyrus & 5th & 8th \\
%         Bristol Palin & 3rd & 9th \\
%         Bobby Bones & 1st & 8th \\
%         \bottomrule
%     \end{tabular}
% \end{table}
...
\begin{figure}[H]
    ...
    \caption{Average rank difference (bias) of eliminees vs. survivors across seasons by methods (percent/rank/Rule A~\ref{subsubsec:d2_ruleA}/Rule B~ \ref{subsubsec:d2_ruleB}) at $\alpha=0.5$. CHANGE TO }
