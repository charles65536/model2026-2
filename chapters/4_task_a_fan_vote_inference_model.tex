...
apply to all active contestants and weeks. Hyperparameters $(\lambda_1,\lambda_2)$ are selected by replay-based diagnostics (Section~\ref{subsec:a_hyper_impl}).
...
We impose simplex constraints for each week:
\begin{align}
