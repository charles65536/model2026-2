...
\begin{itemize}
  \item \textbf{(L1 table)} outputs/tab/tab\_baseline\_consistency.tex: BL-0 baseline set agreement (KPI1: Jaccard similarity) under rank
and percent schemes, and rule divergence (KPI3/FlipRate), with slices: Overall / Rank-era / Percent-era.
  \item \textbf{(L2 figure, optional)} \texttt{outputs/fig/fig\_fliprate\_by\_season.pdf}:
...
% \begin{table}[t]
%   \centering
%   \input{outputs/tab/tab_baseline_consistency.tex}
...
% \begin{figure}[t]
%   \centering
%   \includegraphics[width=\linewidth]{outputs/fig/fig_fliprate_by_season.pdf}
